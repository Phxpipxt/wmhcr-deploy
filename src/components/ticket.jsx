...
export default function Tickets() {
  ...
  return (
    <div className="text-center my-6 px-4">
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:gap-12 lg:max-w-5xl lg:mx-auto">
        {/* Individual Booking Card */}
        <div className="relative border-4 border-pink-300 rounded-lg p-6 shadow-lg bg-white flex flex-col justify-between w-full">
          <div className="flex flex-col items-center text-center space-y-4 flex-1">
            ...
            <p className="text-gray-500">
              Perfect for a deeper experience tailored just for you!
            </p>
            ...
            <p className="font-semibold text-pink-500">
              Early bird Date: Now - Mar 15, 2025
            </p>
            <ul className="space-y-2 text-gray-700">
              <li>
                <span className="ticket-icon">✔</span> Access to
                all sessions
              </li>
              <li>
                <span className="ticket-icon">✔</span> Free
                conference kit
              </li>
              <li>
                <span className="ticket-icon">✔</span> Lunch &
                refreshments
              </li>
              <li>
                <span className="ticket-icon">✔</span> Event
        ...
        {/* Group Booking Card */}
        <div className="relative border-4 border-green-400 rounded-lg p-6 shadow-lg bg-white flex flex-col justify-between w-full">
          <div className="flex flex-col items-center text-center space-y-6 flex-1">
            <h3 className="text-green-500 font-bold text-2xl">Group</h3>
            <p className="text-gray-500">Best for group attendees</p>
            <div>
              <div className="ticket-head">Contact Us</div>
              <div className="ticket-head">
                for Pricing
              </div>
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 w-full bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 text-center block"
          >
            Request a Quote
          </a>
        </div>
